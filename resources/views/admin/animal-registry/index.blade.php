    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <div class="text-sm text-gray-500">
                        Включает животных с номерами заявок, адресами отлова и связанной документацией
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <div class="text-sm text-gray-500">
                        Найденыши, подброшенные или приведенные владельцами животные
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-green-800">Готовы к выпуску</h3>
                    <p class="text-sm text-green-600">
                        {{ $readyForRelease }} животных завершили все этапы и готовы к выпуску
                    </p>
                </div>
                <div class="ml-auto">
                    <a href="{{ route('admin.departure-planner.create') }}" 
                       class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">
                        Планировать выезд
                    </a>
                </div>
