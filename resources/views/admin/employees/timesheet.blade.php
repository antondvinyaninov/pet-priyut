...
@section('header', 'Табель учета рабочего времени')
        ...
        <div class="px-6 py-3 bg-white border-b border-gray-100">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <a href="{{ route('admin.employees.timesheet', ['employee' => $employee, 'year' => $year, 'month' => $month - 1 < 1 ? 12 : $month - 1, 'year' => $month - 1 < 1 ? $year - 1 : $year]) }}" 
                    ...
                    <a href="{{ route('admin.employees.timesheet', ['employee' => $employee, 'year' => $year, 'month' => $month + 1 > 12 ? 1 : $month + 1, 'year' => $month + 1 > 12 ? $year + 1 : $year]) }}" 
                       class="text-gray-500 hover:text-gray-700">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
