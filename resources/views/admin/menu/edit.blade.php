    ...
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Редактирование пункта меню</h3>
            </div>
            
            <form method="POST" action="{{ route('admin.menu.update', $menuItem) }}" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="icon" id="icon" value="{{ old('icon', $menuItem->icon) }}" required maxlength="10"
                    ...
                    <div>
                        ...
                        <input type="text" name="route" id="route" value="{{ old('route', $menuItem->route) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="submenu_id" id="submenu_id" value="{{ old('submenu_id', $menuItem->submenu_id) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                ...
                <div class="mt-6 space-y-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_submenu" id="is_submenu" value="1" 
                               {{ old('is_submenu', $menuItem->is_submenu) ? 'checked' : '' }}
